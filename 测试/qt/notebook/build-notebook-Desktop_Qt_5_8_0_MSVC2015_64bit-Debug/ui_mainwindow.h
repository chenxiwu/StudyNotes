...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/new/prefix1/imageres.dll(2).ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_N->setIcon(icon);
        action_O = new QAction(MainWindow);
        action_O->setObjectName(QStringLiteral("action_O"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/prefix1/imageres.dll(162).ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_O->setIcon(icon1);
        action_C = new QAction(MainWindow);
        action_C->setObjectName(QStringLiteral("action_C"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/IMG_2318.JPG"), QSize(), QIcon::Normal, QIcon::Off);
        action_C->setIcon(icon2);
        action_S = new QAction(MainWindow);
        action_S->setObjectName(QStringLiteral("action_S"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/new/prefix1/imageres.dll(184).ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_S->setIcon(icon3);
        action_A = new QAction(MainWindow);
        action_A->setObjectName(QStringLiteral("action_A"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/new/prefix1/imageres.dll(185).ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_A->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/new/prefix1/imageres.dll(18).ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mainToolBar->addAction(action_A);
        mainToolBar->addSeparator();
        mainToolBar->addAction(action_F);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_F->setShortcut(QApplication::translate("MainWindow", "Ctrl+F", Q_NULLPTR));
